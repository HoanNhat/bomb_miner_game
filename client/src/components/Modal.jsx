    ...
    <>
      <div
        ...
        className={`${
          !isShow
            ? "hidden"
            : "overflow-y-auto overflow-x-auto fixed z-50 flex flex-col justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full"
        } ${isEnd ? "cursor-default": "cursor-none "}`}
      >
